  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardFront image = {posterMap[this.props.movieProp.poster]}
          />

        <CardBack genres = {this.props.movieProp.genres}
          title = {this.props.movieProp.title}
          rating = {this.props.movieProp.IMDBRating}
          />
      </div>
    )
  }
